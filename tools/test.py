...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/kitti_models/pointrcnn_dsasa.yaml', help='specify the config for training')

    parser.add_argument('--batch_size', type=int, default=None, required=False, help='batch size for training')
    parser.add_argument('--workers', type=int, default=4, help='number of workers for dataloader')
    parser.add_argument('--extra_tag', type=str, default='default', help='extra tag for this experiment')
    parser.add_argument('--ckpt', type=str, default='/home/ubuntu/codes/2025codes/SASA2/output/kitti_models/pointrcnn_dsasa/default/ckpt/checkpoint_epoch_80.pth', help='checkpoint to start from')
