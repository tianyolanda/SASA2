...
def parse_config():
    ...
    parser.add_argument('--ckpt', type=str, default='/home/ubuntu/codes/2025codes/SASA2/output/kitti_models/3dssd_dsasa/default/ckpt/checkpoint_epoch_80.pth', help='checkpoint to start from')
